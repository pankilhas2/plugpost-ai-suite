# Teste da Clever Service Edge Function - Versão Final
...
try {
    ...
    Write-Host "📝 Preview: $($response.content.Substring(0, [Math]::Min(50, $response.content.Length))..." -ForegroundColor White
} catch {
    Write-Host "❌ Erro: $($_.Exception.Message)" -ForegroundColor Red
}
